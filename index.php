...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse " id="myNavbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#whatwe">What We Do</a>
                                </li>
                                <li class="nav-item">
    ...
    <section class="iq-blog pt-0 pt-5" id="wethink">
        <div class="container pt-4">
            <div class="row">
                <div class="col-sm-12">
                    <div class="title-box">
                        <h2 class="title font-weight-bold">What <b class="headings">We Think</b></h2>
                        <!-- <p class="sub-title">Simply dummy has been the industry's standard dummy text.</p> -->
                    </div>
                </div>
            </div>
